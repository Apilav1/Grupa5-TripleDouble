...
namespace BestDeal.Controllers
{
    public class KorisniksController : Controller
    {
        ...
        public KorisniksController(BestDealContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Ime,Prezime,KorisnickoIme,Password")] Korisnik korisnik)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Ime,Prezime,KorisnickoIme,Password,Registrovan")] Korisnik korisnik)
        {
